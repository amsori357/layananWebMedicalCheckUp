                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($p["jadwal_pemeriksaan"]); ?></td>
                            <td><?= htmlspecialchars($p["status_pemeriksaan"]); ?></td>
                            <td>
                                <ul>
                                    <li>
                                        <a href="inputhasilpemeriksaan.php?id_pasien=<?= htmlspecialchars(urlencode($p["id_pasien"])); ?>">Input Hasil Pemeriksaan</a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
