                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>
                                        <a href="editpasien.php?id_pasien=<?= htmlspecialchars(urlencode($p["id_pasien"])); ?>">Ubah</a>
                                        <a href="hapuspasien.php?id_pasien=<?= htmlspecialchars(urldecode($p["id_pasien"])); ?>">Hapus</a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
